/* Lab 2 - Instructions
	...
	3. Then copy the file into another file called  lab2.c  making 
	   sure to preserve errors.c (in case you need to refer to the 
		instructions again).
	...
	7. After you have done all these steps, then you can submit your
	   fixed lab2.c to Vocareum.  Your TA can help you if you have 
		trouble doing that.  
*/
...
int main (void) 
{
	...
	// Get user input
	printf("Enter triangle base (cm): ");	//Fix printf( and missing semicolon
